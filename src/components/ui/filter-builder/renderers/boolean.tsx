...
export const FilterBooleanRenderer = ({
  ...
  // When inverse is set, the property's "natural" true means a negative state
  // (e.g. `deactivated`), so we flip the labels so the user can think in
  // positive terms ("Active" / "Inactive").
